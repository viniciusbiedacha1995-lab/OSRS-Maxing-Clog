...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { name: 'Graceful hood (blue)', obtained: false, icon: 'Graceful hood (blue)' },
      { name: 'Graceful cape (blue)', obtained: false, icon: 'Graceful cape (blue)' },
      { name: 'Graceful top (blue)', obtained: false, icon: 'Graceful top (blue)' },
      { name: 'Graceful legs (blue)', obtained: false, icon: 'Graceful legs (blue)' },
      { name: 'Graceful gloves (blue)', obtained: false, icon: 'Graceful gloves (blue)' },
      { name: 'Graceful boots (blue)', obtained: false, icon: 'Graceful boots (blue)' },
    ],
  },
  {
