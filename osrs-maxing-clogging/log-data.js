...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      { name: 'Red decorative full helm', obtained: false, icon: 'Decorative full helm (red)' },
      { name: 'Red decorative helm', obtained: false, icon: 'Decorative helm (red)' },
      { name: 'Red decorative body', obtained: false, icon: 'Decorative armour (red platebody)' },
      { name: 'Red decorative legs', obtained: false, icon: 'Decorative armour (red platelegs)' },
      { name: 'Red decorative skirt', obtained: false, icon: 'Decorative armour (red plateskirt)' },
      { name: 'Red decorative boots', obtained: false, icon: 'Decorative boots (red)' },
      { name: 'Red decorative shield', obtained: false, icon: 'Decorative shield (red)' },
      { name: 'Red decorative sword', obtained: false, icon: 'Decorative sword (red)' },
      { name: 'White decorative full helm', obtained: false, icon: 'Decorative full helm (white)' },
      { name: 'White decorative helm', obtained: false, icon: 'Decorative helm (white)' },
      { name: 'White decorative body', obtained: false, icon: 'Decorative armour (white platebody)' },
      { name: 'White decorative legs', obtained: false, icon: 'Decorative armour (white platelegs)' },
      { name: 'White decorative skirt', obtained: false, icon: 'Decorative armour (white plateskirt)' },
      { name: 'White decorative boots', obtained: false, icon: 'Decorative boots (white)' },
      { name: 'White decorative shield', obtained: false, icon: 'Decorative shield (white)' },
      { name: 'White decorative sword', obtained: false, icon: 'Decorative sword (white)' },
      ...
      { name: 'Decorative magic hat', obtained: false, icon: 'Decorative armour (magic hat)' },
      { name: 'Decorative magic robe top', obtained: false, icon: 'Decorative armour (magic top)' },
      { name: 'Decorative magic robe legs', obtained: false, icon: 'Decorative armour (magic legs)' },
      { name: 'Decorative ranged top', obtained: false, icon: 'Decorative armour (ranged top)' },
      { name: 'Decorative ranged legs', obtained: false, icon: 'Decorative armour (ranged legs)' },
      { name: 'Decorative quiver', obtained: false, icon: 'Decorative armour (quiver)' },
      { name: 'Saradomin halo', obtained: false },
      { name: 'Zamorak halo', obtained: false },
      { name: 'Guthix halo', obtained: false },
      { name: 'Gold decorative full helm', obtained: false, defaultExcluded: true, icon: 'Decorative full helm (gold)' },
      { name: 'Gold decorative helm', obtained: false, defaultExcluded: true, icon: 'Decorative helm (gold)' },
      { name: 'Gold decorative body', obtained: false, defaultExcluded: true, icon: 'Decorative armour (gold platebody)' },
      { name: 'Gold decorative legs', obtained: false, defaultExcluded: true, icon: 'Decorative armour (gold platelegs)' },
      { name: 'Gold decorative skirt', obtained: false, defaultExcluded: true, icon: 'Decorative armour (gold plateskirt)' },
      { name: 'Gold decorative boots', obtained: false, defaultExcluded: true, icon: 'Decorative boots (gold)' },
      { name: 'Gold decorative shield', obtained: false, defaultExcluded: true, icon: 'Decorative shield (gold)' },
      { name: 'Gold decorative sword', obtained: false, defaultExcluded: true, icon: 'Decorative sword (gold)' },
    ],
  },
  {
    id: 'trouble_brewing',
    ...
    items: [
      { name: 'Red rum', obtained: false, icon: 'Rum (red)' },
      { name: 'Blue rum', obtained: false, icon: 'Rum (blue)' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Medallion fragment #1', obtained: true, icon: 'Medallion fragment (1)' },
      { name: 'Medallion fragment #2', obtained: false, icon: 'Medallion fragment (2)' },
      { name: 'Medallion fragment #3', obtained: false, icon: 'Medallion fragment (3)' },
      { name: 'Medallion fragment #4', obtained: false, icon: 'Medallion fragment (4)' },
      { name: 'Medallion fragment #5', obtained: false, icon: 'Medallion fragment (5)' },
      { name: 'Medallion fragment #6', obtained: false, icon: 'Medallion fragment (6)' },
      { name: 'Medallion fragment #7', obtained: false, icon: 'Medallion fragment (7)' },
      { name: 'Medallion fragment #8', obtained: false, icon: 'Medallion fragment (8)' },
    ],
  },
  {
    id: 'boat_paints',
  ...
  },
  {
    ...
    name: 'Camdozaal',
    group: 'Other',
    note: '[API 22/09] 3/10 confirmed in-game. Names confirmed from the wiki category, but which 3 specific ones are obtained isn\'t known yet — the first 3 below are arbitrary.',
    items: [
      { name: 'Barronite mace', obtained: true },
      { name: 'Barronite head', obtained: true },
      { name: 'Barronite handle', obtained: true },
      { name: 'Barronite guard', obtained: false },
      { name: 'Ancient globe', obtained: false },
      { name: 'Ancient ledger', obtained: false },
      { name: 'Ancient astroscope', obtained: false },
      { name: 'Ancient treatise', obtained: false },
      { name: 'Ancient carcanet', obtained: false },
      { name: 'Imcando hammer', obtained: false },
    ],
  },
  {
    ...
    group: 'Other',
    note: '[API 22/09] 9/19 confirmed in-game. Names confirmed from the wiki category, but which 9 specific hats are obtained isn\'t known yet — the first 9 below are arbitrary.',
    items: [
      { name: 'Chompy bird hat (ogre bowman)', obtained: true },
      { name: 'Chompy bird hat (bowman)', obtained: true },
      { name: 'Chompy bird hat (ogre yeoman)', obtained: true },
      { name: 'Chompy bird hat (yeoman)', obtained: true },
      { name: 'Chompy bird hat (ogre marksman)', obtained: true },
      { name: 'Chompy bird hat (marksman)', obtained: true },
      { name: 'Chompy bird hat (ogre woodsman)', obtained: true },
      { name: 'Chompy bird hat (woodsman)', obtained: true },
      { name: 'Chompy bird hat (ogre forester)', obtained: true },
      { name: 'Chompy bird hat (forester)', obtained: false },
      { name: 'Chompy bird hat (ogre bowmaster)', obtained: false },
      { name: 'Chompy bird hat (bowmaster)', obtained: false },
      { name: 'Chompy bird hat (ogre expert)', obtained: false },
      { name: 'Chompy bird hat (expert)', obtained: false },
      { name: 'Chompy bird hat (ogre dragon archer)', obtained: false },
      { name: 'Chompy bird hat (dragon archer)', obtained: false },
      { name: 'Chompy bird hat (expert ogre dragon archer)', obtained: false },
      { name: 'Chompy bird hat (expert dragon archer)', obtained: false },
  ...
  },
  {
    ...
    group: 'Other',
    note: '[API 22/09] 2/7 confirmed in-game. Names confirmed from the wiki category, but which 2 specific ones are obtained isn\'t known yet — the first 2 below are arbitrary.',
    items: [
      { name: 'Tea flask', obtained: true },
      { name: 'Plain satchel', obtained: true },
      { name: 'Green satchel', obtained: false },
      { name: 'Red satchel', obtained: false },
      { name: 'Black satchel', obtained: false },
      { name: 'Gold satchel', obtained: false },
      { name: 'Rune satchel', obtained: false },
    ],
  },
  {
