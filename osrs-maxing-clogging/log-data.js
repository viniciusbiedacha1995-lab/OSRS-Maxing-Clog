...
const CATEGORIES = [
  ...
  },
  {
    ...
    name: 'Camdozaal',
    group: 'Other',
    note: '[API 22/09] 3/10 confirmed in-game — Ancient treatise, Ancient carcanet and Imcando hammer, confirmed by the user in-game.',
    items: [
      { name: 'Barronite mace', obtained: false },
      { name: 'Barronite head', obtained: false },
      { name: 'Barronite handle', obtained: false },
      ...
      { name: 'Ancient treatise', obtained: true },
      { name: 'Ancient carcanet', obtained: true },
      { name: 'Imcando hammer', obtained: true },
    ],
  },
  {
