...
const CATEGORIES = [
  ...
  },
  {
    ...
    group: 'Other',
    note: '[API 22/09] 2/7 confirmed in-game — Tea flask and Red satchel, matched by tile position against the in-game screenshot.',
    items: [
      { name: 'Tea flask', obtained: true },
      { name: 'Plain satchel', obtained: false },
      { name: 'Green satchel', obtained: false },
      { name: 'Red satchel', obtained: true },
