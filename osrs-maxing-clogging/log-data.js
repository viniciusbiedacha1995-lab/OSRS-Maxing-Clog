...
const CATEGORIES = [
  ...
  },
  {
    ...
    hoursLow: 13,
    hoursHigh: 13,
    note: '39 log items — cutoff at 100 tickets covers the red + white + hood/cloak/banner/magic/ranged/halo tiers; the 8 gold-tier pieces (400-800 tickets each) are past the cutoff and start unchecked. The 24 red/white/gold pieces share one representative icon — the wiki names each one differently from the shop listing (e.g. "Decorative full helm (red)", "Decorative armour (red platebody)", no single pattern), not worth chasing individually.',
    items: [
      { name: 'Red decorative full helm', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative helm', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative body', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative legs', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative skirt', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative boots', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative shield', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'Red decorative sword', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative full helm', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative helm', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative body', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative legs', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative skirt', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative boots', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative shield', obtained: false, icon: 'Castle_wars_ticket' },
      { name: 'White decorative sword', obtained: false, icon: 'Castle_wars_ticket' },
      ...
      { name: 'Gold decorative full helm', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative helm', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative body', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative legs', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative skirt', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative boots', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative shield', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
      { name: 'Gold decorative sword', obtained: false, defaultExcluded: true, icon: 'Castle_wars_ticket' },
    ],
  },
  {
    id: 'trouble_brewing',
