...
const CATEGORIES = [
  ...
  },
  {
    ...
    group: 'Other',
    note: 'Sequential Ape Atoll Agility Course unlock — each transform is later than the last. Names confirmed, obtained/pending status not checked yet.',
    items: [
      { name: 'Monkey', obtained: null },
      { name: 'Karamjan monkey', obtained: null },
      { name: 'Zombie monkey', obtained: null },
      { name: 'Maniacal monkey', obtained: null },
      { name: 'Skeleton monkey', obtained: null },
      { name: 'Kruk jr monkey', obtained: null },
      { name: 'Princely monkey', obtained: null },
    ],
  },
  {
    id: 'camdozaal',
    name: 'Camdozaal',
    group: 'Other',
    note: '10 log items (Barronite mace/Imcando hammer components + a pet chance) — exact individual names not confirmed yet, icon below is representative.',
    items: [
      { name: 'Camdozaal reward #1', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #2', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #3', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #4', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #5', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #6', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #7', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #8', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #9', obtained: null, icon: 'Barronite mace' },
      { name: 'Camdozaal reward #10', obtained: null, icon: 'Barronite mace' },
    ],
  },
  {
    ...
    group: 'Other',
    note: '19 log items (18 hat colors + Chompy chick pet) — exact individual names not confirmed yet, icon below is representative.',
    items: [
      { name: 'Chompy bird hat #1', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #2', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #3', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #4', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #5', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #6', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #7', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #8', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #9', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #10', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #11', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #12', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #13', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #14', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #15', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #16', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #17', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy bird hat #18', obtained: null, icon: 'Chompy bird hat (woodsman)' },
      { name: 'Chompy chick (pet)', obtained: null, defaultExcluded: true, icon: 'Chompy chick' },
    ],
  },
  {
    ...
    group: 'Other',
    note: '7 log items (hybrid creatures, e.g. Spidine, Unicow) — exact individual names not confirmed yet, icon below is representative.',
    items: [
      { name: 'Creature Creation reward #1', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #2', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #3', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #4', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #5', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #6', obtained: null, icon: 'Unicow' },
      { name: 'Creature Creation reward #7', obtained: null, icon: 'Unicow' },
    ],
  },
  {
    ...
    group: 'Other',
    note: '10 log items (notes for the Fossil island note book, from the House on the Hill stone chests) — exact individual names not confirmed yet, icon below is representative.',
    items: [
      { name: 'Fossil Island note #1', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #2', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #3', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #4', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #5', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #6', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #7', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #8', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #9', obtained: null, icon: 'Short note' },
      { name: 'Fossil Island note #10', obtained: null, icon: 'Short note' },
    ],
  },
];
