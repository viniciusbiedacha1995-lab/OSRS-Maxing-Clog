...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      { name: 'Karamjan monkey', obtained: false },
      { name: 'Zombie monkey', obtained: false },
      { name: 'Maniacal monkey', obtained: false },
      { name: 'Skeleton monkey', obtained: false },
      { name: 'Kruk jr monkey', obtained: false },
